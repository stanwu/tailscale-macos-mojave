...
// Mojave-compatible replacements for SecTrustCopyCertificateChain (macOS 12+)
// Using SecTrustGetCertificateCount (macOS 10.7+) and SecTrustGetCertificateAtIndex (macOS 10.7+)
